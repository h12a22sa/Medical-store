          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Manage medicine distributors, purchase orders, trade credit, and settlement ledgers
              </p>
            </div>
          </div>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filteredSuppliers.map(s => (
              <div
                key={s.id}
                className="flex flex-col justify-between rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-slate-800/80 dark:bg-slate-900 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all"
              >
                <div>
                  <div className="flex items-start justify-between">
                    <div>
                      <span className="rounded-md bg-emerald-50 px-2 py-0.5 text-[9px] font-bold uppercase text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300">
                        Distributor
                      </span>
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 font-bold shadow-xs">
                      {s.companyName[0]}
                    </div>
                  </div>
                ...
                <div className="mt-5 border-t border-slate-100 pt-3 dark:border-slate-800 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl bg-slate-100/80 px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-emerald-600 hover:text-white dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-emerald-600 transition-all cursor-pointer"
                  >
                ...
                {supplierPayments.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="py-14 text-center text-slate-400">
                      <p className="font-bold text-xs text-slate-600 dark:text-slate-300">No supplier payments recorded yet</p>
                    </td>
                  </tr>
                ) : (
          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleSubmitPayment} className="mt-4 space-y-3.5 text-xs">
              ...
              <div>
                ...
                >
                  <option value="BANK_TRANSFER">Bank Transfer (HBL / Meezan / MCB)</option>
            ...
            <form onSubmit={handleSaveSupplier} className="mt-4 space-y-3 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50/70 px-3.5 py-2.5 font-semibold text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-white focus:border-emerald-500 focus:outline-none font-mono"
                />
              </div>
